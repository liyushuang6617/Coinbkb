...
public class E_ZCAAdapter extends BaseAdapter {
    private Context context;
    private List<ZiChanBean.changebalanceBean> list;
    private boolean yan;

    public E_ZCAAdapter(Context context, List<ZiChanBean.changebalanceBean> list) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        ZiChanBean.changebalanceBean bean = list.get(i);
        holder.name.setText(bean.getCurrency_name());
        holder.keyong.setText(bean.getChange_balance());
        holder.dongjie.setText(bean.getLock_change_balance());
         holder.zhehe.setText(bean.getCny_price());
        if (yan&Double.valueOf(bean.getChange_balance())==0) {
