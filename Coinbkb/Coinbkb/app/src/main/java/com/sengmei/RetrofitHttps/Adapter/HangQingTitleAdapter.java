...
public class HangQingTitleAdapter extends BaseAdapter {
    private List<HangQingBean.MessageBean> data;
    private Context context;
    private int selectedPosition = 0;// 选中的位置
    public HangQingTitleAdapter(Context context, List<HangQingBean.MessageBean> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ViewHolder holder;
        if (convertView==null){
            ...
            holder=new HangQingTitleAdapter.ViewHolder();
        ...
        HangQingBean.MessageBean objectBean = data.get(position);
