...
public class DingDanXiangQingActivity2 extends BaseActivity {
    ...
    private TextView kaihum1,mm3,wxm5,quere;
    ...
    public void initViews() {
        ...
        quere= findViewById(R.id.quere);
        quere.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                di=new CustomDialog(DingDanXiangQingActivity2.this,R.style.customDialog,R.layout.c2cfabudialog_item);
                di.show();
                dia();
            }
        });
    ...
    public void initData() {
        shou.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DingDanXiangQingActivity2.this, ShangPuActivity.class);
    ...
    private void TiBiListShow() {Log.e("AAIdsAAA", "@@TiBiListShow=" +Ids);
        GetDataFromServerInterface mFromServerInterface = GetDataFromServer.getInstance(DingDanXiangQingActivity2.this).getService();
        ...
        indexdata.enqueue(new Callback<DingDanXiangQingBean>() {
            ...
            public void onResponse(Call<DingDanXiangQingBean> call, Response<DingDanXiangQingBean> response) {
                if (response.body() == null) {
                    StringUtil.ToastShow(DingDanXiangQingActivity2.this,"请先登录");
                    return;
                }
                if (response.body().getType().equals("ok")) {
                    ...
                    kaihum1.setText(response.body().getMessage().getBank_address());
                     ...
                     if (response.body().getMessage().getIs_sure().equals("0")){
                         quere.setVisibility(View.GONE);
                     }else {
                         quere.setVisibility(View.VISIBLE);
                     }
                }
            }
    ...
    private void quxiaoShow() {Log.e("AAIdsAAA", "@@quxiaoShow=" +Ids);
        ...
        indexdata.enqueue(new Callback<ZhuCeBean>() {
            ...
            public void onResponse(Call<ZhuCeBean> call, Response<ZhuCeBean> response) {
                if (response.body() == null) {
                    Toast.makeText(DingDanXiangQingActivity2.this, "暂无数据", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (response.body().getType().equals("ok")) {
                    Toast.makeText(DingDanXiangQingActivity2.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
    ...
    public void dia(){
        LayoutInflater in = LayoutInflater.from(DingDanXiangQingActivity2.this);
        ...
        querens.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (StringUtil.isBlank(et_dialogContent.getText().toString().trim())){
                    StringUtil.ToastShow1(DingDanXiangQingActivity2.this,"密码不能为空");
                    return;
                }
