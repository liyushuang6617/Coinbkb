...
public class E_WoDeJiaoYiAdapter extends BaseAdapter {
    ...
    public E_WoDeJiaoYiAdapter(Context context, List<WDJYBean.ObjectBean> list) {
    ...
    private void GouMaioutShow(final String ss) {
        ...
        Call<ZhuCeBean> indexdata = mFromServerInterface.getdels(ss,"in");
    ...
    private void GouMaioutShow1(final String ss) {
        GetDataFromServerInterface mFromServerInterface = GetDataFromServer.getInstance(context).getService();
        Call<ZhuCeBean> indexdata = mFromServerInterface.getdels1(ss,"in");
        indexdata.enqueue(new Callback<ZhuCeBean>() {
