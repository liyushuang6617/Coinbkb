...
public class ThreeListDownAdapter extends BaseAdapter {
    private Context context;
    private List<ThreeListDownBean> list;

    public ThreeListDownAdapter(Context context, List<ThreeListDownBean> list) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        ThreeListDownBean bean = list.get(i);
