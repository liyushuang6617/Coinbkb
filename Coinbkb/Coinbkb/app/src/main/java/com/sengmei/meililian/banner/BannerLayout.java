package com.sengmei.meililian.banner;
...
import com.sengmei.meililian.banner.layoutmanager.BannerLayoutManager;
import com.sengmei.meililian.banner.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    private int WHAT_AUTO_PLAY = 2000;
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        autoPlayDuration = a.getInt(R.styleable.BannerLayout_interval, 2000);
        isAutoPlaying = a.getBoolean(R.styleable.BannerLayout_autoPlaying, true);
        itemSpace = a.getInt(R.styleable.BannerLayout_itemSpace, 10);
        ...
        if (mSelectedDrawable == null) {
            ...
            selectedGradientDrawable.setSize(dp2px(20), dp2px(2));
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setSize(dp2px(20), dp2px(2));
           // unSelectedGradientDrawable.setCornerRadius(dp2px(5) / 1);
            mUnselectedDrawable = new LayerDrawable(new Drawable[]{unSelectedGradientDrawable});
        }

        indicatorMargin = dp2px(0);
