...
public class Fragment1TwoAdapter extends BaseAdapter {
    private Context context;
    private List<HangQingBean.quotationBean> list;

    public Fragment1TwoAdapter(Context context, List<HangQingBean.quotationBean> list) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(context).inflate(R.layout.fragmenttwolist2_item, null);
