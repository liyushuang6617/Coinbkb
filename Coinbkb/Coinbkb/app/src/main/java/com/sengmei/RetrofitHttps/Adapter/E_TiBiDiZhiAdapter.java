...
public class E_TiBiDiZhiAdapter extends BaseAdapter {
    ...
    private List<TiBidiZhiBean.ObjectBean> list;
    private int point;

    public E_TiBiDiZhiAdapter(Context context, List<TiBidiZhiBean.ObjectBean> list) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        TiBidiZhiBean.ObjectBean bean = list.get(i);
        holder.name.setText(bean.getNotes());
        holder.addrss.setText(bean.getAddress());
        holder.delet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                point=i;
                TianJiaShow(""+list.get(i).getId());
            }
        });
