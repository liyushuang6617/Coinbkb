...
public class C2CJiaoYiActivity1 extends BaseActivity implements View.OnClickListener ,MenuChooseBack {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (NetUtils.isConnected(C2CJiaoYiActivity1.this)) {
                            ...
                            StringUtil.ToastShow(C2CJiaoYiActivity1.this, "网络未连接");
                        }
    ...
    private void setList(final List<FaBiTiTleBean.ObjectBean> news) {
        ...
        hlist.addAll(news);
        mAdapter = new FaBiTitleAdapter(C2CJiaoYiActivity1.this, hlist);
    ...
    private void DataView() {
        GetDataFromServerInterface mFromServerInterface = GetDataFromServer.getInstance(C2CJiaoYiActivity1.this).getService();
        ...
        indexdata.enqueue(new Callback<FaBiTiTleBean>() {
            ...
            public void onResponse(Call<FaBiTiTleBean> call, Response<FaBiTiTleBean> response) {
                if (response.body() == null) {
                    startActivity(new Intent(C2CJiaoYiActivity1.this, LoginActivity.class));
                    return;
                }
            ...
            public void onFailure(Call<FaBiTiTleBean> call, Throwable t) {
                ...
                Toast.makeText(C2CJiaoYiActivity1.this, "请先登录", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(C2CJiaoYiActivity1.this, LoginActivity.class));
            }
        });
    }
    ...
    private void setListD(List<C2CJListBean.dataBean> news){
        ...
        if (listD.size() > 0) {
            ...
            adapter = new C2CJListAdapter(C2CJiaoYiActivity1.this, listD);
    ...
    private void ETHShow(final String curren) { refreshLayout.setRefreshing(true);
        GetDataFromServerInterface mFromServerInterface = GetDataFromServer.getInstance(C2CJiaoYiActivity1.this).getService();
        Call<C2CJListBean> indexdata = mFromServerInterface.getURLC2Cmy_ctoc(TYPES, curren);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.chushou:
                ...
                break;
            case R.id.jilu:
                startActivity(new Intent(C2CJiaoYiActivity1.this, C2CJiaoYiActivity.class));
                break;
            default:
                break;
        }
